...
public class PonyParser implements PsiParser, LightPsiParser {
  ...
  private static boolean controlblock_0_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "controlblock_0_5")) return false;
    controlblock_0_5_0(b, l + 1);
    return true;
  }

  // elifdef | (ELSE annotatedrawseq)
  private static boolean controlblock_0_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "controlblock_0_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = elifdef(b, l + 1);
    if (!r) r = controlblock_0_5_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // ELSE annotatedrawseq
  private static boolean controlblock_0_5_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "controlblock_0_5_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // binding id_ref COLON type [EQUALS infix] [doc_string]
  ...
  /* ********************************************************** */
  // id_ref [COLON type] [EQUALS infix]
  ...
  /* ********************************************************** */
  // (FUN | BE | NEW) [annotatedids] [cap | AT] id_ref [typeparams] LP [params] RP [COLON type] [QM] [ARROW] [doc_string] [rawseq]
  ...
  /* ********************************************************** */
  // [id_ref DOT] type_ref [typeargs] [cap | gencap] [CARET | BANG]
  ...
  //   | LBC [annotatedids] [cap] [id_ref] [typeparams] LP [lambdaparams] RP [lambdacaptures] [COLON type] [QM] ARROW rawseq RBC [cap]
  //   | RCVR [annotatedids] [cap] [id_ref] [typeparams] LP [lambdaparams] RP [lambdacaptures] [COLON type] [QM] ARROW rawseq RBC [cap]
  ...
  /* ********************************************************** */
  // USE [id_ref EQUALS] (string | use_ffi) [IF infix]
  ...
  // id_ref EQUALS
  private static boolean usestmt_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "usestmt_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = id_ref(b, l + 1);
    r = r && consumeToken(b, EQUALS);
