...
public class PonyPrimitiveDeclarationImpl extends ASTWrapperPsiElement implements PonyPrimitiveDeclaration {

  public PonyPrimitiveDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
