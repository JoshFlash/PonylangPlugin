...
public class PonyFlagatomImpl extends ASTWrapperPsiElement implements PonyFlagatom {

  public PonyFlagatomImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PonyVisitor visitor) {
    visitor.visitFlagatom(this);
  }
