...
public class PonyInterfaceDeclarationImpl extends ASTWrapperPsiElement implements PonyInterfaceDeclaration {

  public PonyInterfaceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
