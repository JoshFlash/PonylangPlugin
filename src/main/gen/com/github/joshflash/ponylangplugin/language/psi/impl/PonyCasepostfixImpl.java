...
public class PonyCasepostfixImpl extends ASTWrapperPsiElement implements PonyCasepostfix {

  public PonyCasepostfixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PonyVisitor visitor) {
    visitor.visitCasepostfix(this);
  }
